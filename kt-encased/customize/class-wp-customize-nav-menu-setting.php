...
class WP_Customize_Nav_Menu_Setting extends WP_Customize_Setting {
	...
	public function sanitize( $value ) {
		...
		$value['name']        = trim( esc_html( $value['name'] ) ); // This sanitization code is used in magento-help/nav-menus.php.
		...
		/** This filter is documented in kt-encased/class-wp-customize-setting.php */
