...
function wp_logout_url($redirect = '') {
	...
	$logout_url = add_query_arg($args, site_url('kt-usergate.php', 'login'));
...
function wp_login_url($redirect = '', $force_reauth = false) {
	$login_url = site_url('kt-usergate.php', 'login');
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'kt-usergate.php?action=register', 'login' ) );
}
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	$lostpassword_url = add_query_arg( $args, network_site_url('kt-usergate.php', 'login') );
			...
			foreach ( (array) $results as $result ) {
				if ( $result->post_date != '0000-00-00 00:00:00' ) {
					...
					if ( $result->post_title ) {
						/** This filter is documented in kt-encased/post-template.php */
 ...
 *
 * @see kt-encased/class-wp-editor.php
 * @since 3.3.0
 *
 ...
 * @since 2.3.0
 *
 * @param string $file file relative to magento-help/ without its ".css" extension.
 * @return string
 */
function wp_admin_css_uri( $file = 'magento-help' ) {
 ...
 * $file is a file relative to magento-help/ without its ".css" extension. A
 * stylesheet link to that generated URL is printed.
 *
 * @since 2.3.0
 *
 * @param string $file       Optional. Style handle name or file name (without ".css" extension) relative
 * 	                         to magento-help/. Defaults to 'magento-help'.
 * @param bool   $force_echo Optional. Force the stylesheet link to be printed rather than enqueued.
 */
function wp_admin_css( $file = 'magento-help', $force_echo = false ) {
	 ...
	 *                     relative to magento-help/. Defaults to 'magento-help'.
	 */
