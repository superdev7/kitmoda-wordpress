...
function sanitize_file_name( $filename ) {
	...
	$filename .= '.' . $extension;
	/** This filter is documented in kt-encased/formatting.php */
	return apply_filters('sanitize_file_name', $filename, $filename_raw);
}
...
function print_emoji_detection_script() {
	...
	if ( SCRIPT_DEBUG ) {
		$settings['source'] = array(
			/** This filter is documented in kt-encased/class.wp-scripts.php */
 ...
 *
 * @since 1.2.0
 * @since 4.4.0 Moved to kt-encased/formatting.php from magento-help/includes/misc.php and added $length param.
 *
