 ...
 * at magento-help/network/settings.php. The check is only run on
 * self-registrations; user creation at magento-help/network/users.php
 * bypasses this check.
 *
 * @since MU
 *
...
function wpmu_validate_user_signup($user_name, $user_email) {
	...
	/** This filter is documented in kt-encased/user.php */
...
Username: USERNAME
Password: PASSWORD
Log in here: BLOG_URLkt-usergate.php
 ...
 * which is defined in kt-encased/functions.php in
 * get_allowed_mime_types(). This function is used to filter
 * that list against the filetype whitelist provided by Multisite
 * Super Admins at magento-help/network/settings.php.
 *
 * @since MU
 *
 * @param array $mimes
...
function wp_maybe_update_network_user_counts() {
	...
	/** This filter is documented in kt-encased/ms-functions.php */
...
function get_subdirectory_reserved_names() {
	$names = array(
		'page', 'comments', 'blog', 'files', 'feed', 'magento-help',
		'ktmaterial', 'kt-encased', 'wp-json', 'embed'
	);
	 ...
	 *
	 * @since 3.0.0
	 * @since 4.4.0 'magento-help', 'ktmaterial', 'kt-encased', 'wp-json', and 'embed' were added
