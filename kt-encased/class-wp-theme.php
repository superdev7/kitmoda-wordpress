...
final class WP_Theme implements ArrayAccess {
	...
	/**
	 * Absolute path to the theme root, usually ktmaterial/themes
	 *
	 * @access private
	 * @var string
	 */
	...
	/**
	 * URL to the theme root, usually an absolute URL to ktmaterial/themes
	 *
	 * @access private
	 * var string
	 */
	...
	public function __construct( $theme_dir, $theme_root, $_child = null ) {
		...
		if ( is_array( $cache ) ) {
			...
			// Properly identify default themes that are inside a directory within ktmaterial/themes.
		...
		if ( ! is_array( $cache ) && $this->template != $this->stylesheet && ! file_exists( $this->theme_root . '/' . $this->template . '/index.php' ) ) {
			...
			// ktmaterial/themes/directory-of-themes/*
	 ...
	 *
	 * This is typically the absolute path to ktmaterial/themes.
	 *
	 * @since 3.4.0
	 * @access public
	 *
	 ...
	 *
	 * This is typically the absolute URL to ktmaterial/themes. This forms the basis
