	...
	foreach ( $wp_theme_directories as $theme_root ) {
		...
		foreach ( $dirs as $dir ) {
			...
			if ( file_exists( $theme_root . '/' . $dir . '/style.css' ) ) {
				// ktmaterial/themes/a-single-theme
				// ktmaterial/themes is $theme_root, a-single-theme is $dir
				...
				$found_theme = false;
				// ktmaterial/themes/a-folder-of-themes/*
				// ktmaterial/themes is $theme_root, a-folder-of-themes is $dir, then themes are $sub_dirs
...
function switch_theme( $stylesheet ) {
	...
	if ( is_admin() && false === get_option( 'theme_mods_' . $stylesheet ) ) {
		 ...
		 * the Customizer when accessing magento-help/widgets.php.
		 */
		if ( 'wp_ajax_customize_save' === current_action() ) {
...
function get_theme_mod( $name, $default = false ) {
	...
	/** This filter is documented in kt-encased/theme.php */
...
function _custom_header_background_just_in_time() {
	...
	if ( current_theme_supports( 'custom-header' ) ) {
		...
		if ( is_admin() ) {
			require_once( ABSPATH . 'magento-help/custom-header.php' );
	...
	if ( current_theme_supports( 'custom-background' ) ) {
		...
		if ( is_admin() ) {
			require_once( ABSPATH . 'magento-help/custom-background.php' );
...
function check_theme_switched() {
	if ( $stylesheet = get_option( 'theme_switched' ) ) {
		...
		if ( $old_theme->exists() ) {
			...
			/** This action is documented in kt-encased/theme.php */
