...
function get_search_comments_feed_link($search_query = '', $feed = '') {
	...
	/** This filter is documented in kt-encased/link-template.php */
...
function get_shortcut_link() {
	...
	include_once( ABSPATH . 'magento-help/includes/class-wp-press-this.php' );
	...
	if ( empty( $link ) ) {
		$src = @file_get_contents( ABSPATH . 'magento-help/js/bookmarklet.min.js' );
...
function get_home_url( $blog_id = null, $path = '', $scheme = null ) {
	...
	if ( ! in_array( $scheme, array( 'http', 'https', 'relative' ) ) ) {
		if ( is_ssl() && ! is_admin() && 'kt-usergate.php' !== $pagenow )
			$scheme = 'https';
		else
...
function get_admin_url( $blog_id = null, $path = '', $scheme = 'admin' ) {
	$url = get_site_url($blog_id, 'magento-help/', $scheme);
...
function includes_url( $path = '', $scheme = null ) {
	 ...
	 * @param string $path Path relative to the URL to the kt-encased directory. Blank string
...
function network_admin_url( $path = '', $scheme = 'admin' ) {
	...
	$url = network_site_url('magento-help/network/', $scheme);
...
function user_admin_url( $path = '', $scheme = 'admin' ) {
	$url = network_site_url('magento-help/user/', $scheme);
