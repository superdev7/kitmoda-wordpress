 ...
 * kt-encased/ms-files.php (ktmaterial/blogs.php in MU).
 *
 * @since 3.0.0
 *
...
function ms_upload_constants() {
	...
	if ( !defined( 'UPLOADBLOGSDIR' ) )
		define( 'UPLOADBLOGSDIR', 'ktmaterial/blogs.dir' );

	// Note, the main site in a post-MU network uses ktmaterial/uploads.
	// This is handled in wp_upload_dir() by ignoring UPLOADS for this case.
	if ( ! defined( 'UPLOADS' ) ) {
		define( 'UPLOADS', UPLOADBLOGSDIR . "/{$wpdb->blogid}/files/" );

		// Uploads dir relative to ABSPATH
		if ( 'ktmaterial/blogs.dir' == UPLOADBLOGSDIR && ! defined( 'BLOGUPLOADDIR' ) )
