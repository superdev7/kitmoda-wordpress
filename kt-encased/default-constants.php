...
function wp_initial_constants() {
	...
	if ( !defined('WP_CONTENT_DIR') )
		define( 'WP_CONTENT_DIR', ABSPATH . 'ktmaterial' ); // no trailing slash, full paths only - WP_CONTENT_URL is defined further down
	...
	// Add define('WP_DEBUG_LOG', true); to enable error logging to ktmaterial/debug.log.
...
function wp_plugin_directory_constants() {
	if ( !defined('WP_CONTENT_URL') )
		define( 'WP_CONTENT_URL', get_option('siteurl') . '/ktmaterial'); // full url - WP_CONTENT_DIR is defined further up
	...
	if ( !defined('PLUGINDIR') )
		define( 'PLUGINDIR', 'ktmaterial/plugins' ); // Relative to ABSPATH. For back compat.
	...
	if ( !defined( 'MUPLUGINDIR' ) )
		define( 'MUPLUGINDIR', 'ktmaterial/mu-plugins' ); // Relative to ABSPATH. For back compat.
}
...
function wp_cookie_constants() {
	...
	if ( !defined('ADMIN_COOKIE_PATH') )
		define( 'ADMIN_COOKIE_PATH', SITECOOKIEPATH . 'magento-help' );
