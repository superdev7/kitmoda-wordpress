	...
	if ( !defined( 'WP_LANG_DIR' ) ) {
		if ( file_exists( WP_CONTENT_DIR . '/languages' ) && @is_dir( WP_CONTENT_DIR . '/languages' ) || !@is_dir(ABSPATH . WPINC . '/languages') ) {
			...
			if ( !defined( 'LANGDIR' ) ) {
				...
				define( 'LANGDIR', 'ktmaterial/languages' );
			}
		} else {
			/**
			 * Server path of the language directory.
 ...
 *
 * If an object-cache.php file exists in the ktmaterial directory,
...
function wp_not_installed() {
	if ( is_multisite() ) {
		...
		$link = wp_guess_url() . '/magento-help/install.php';
 ...
 *
 * The default directory is ktmaterial/mu-plugins. To change the default
 ...
 *
 * The default directory is ktmaterial/plugins. To change the default
...
function wp_load_translations_early() {
	...
	while ( true ) {
		...
		if ( @is_dir( ABSPATH . 'ktmaterial/languages' ) )
			$locations[] = ABSPATH . 'ktmaterial/languages';
