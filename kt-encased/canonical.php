...
function redirect_canonical( $requested_url = null, $do_redirect = true ) {
	...
	// If we're not in magento-help and the post has been published and preview nonce
	...
	if ( is_404() ) {
		...
		if ( 'wp-register.php' == basename( $redirect['path'] ) ) {
			if ( is_multisite() ) {
				/** This filter is documented in kt-usergate.php */
...
function wp_redirect_admin_locations() {
	...
	$admins = array(
		home_url( 'magento-help', 'relative' ),
	...
	$logins = array(
		home_url( 'kt-usergate.php', 'relative' ),
