...
/** This action is documented in kt-encased/feed-rss2.php */
...
<channel>
	...
	<sy:updatePeriod><?php
		/** This filter is documented in kt-encased/feed-rss2.php */
	...
	<item>
		<title><?php
			if ( !is_singular() ) {
				...
				/** This filter is documented in kt-encased/feed.php */
