...
if ( !EDD_FES()->vendors->vendor_can_delete_product($post_id) ){
	...
	<h1 class="fes-headers" id="fes-delete-product-page-title"><?php echo sprintf( __( 'Delete %s', 'edd_fes' ), EDD_FES()->vendors->get_product_constant_name( $plural = false, $uppercase = true ) ) .  ' ' . __('#: ','edd_fes'); echo $post_id; ?></h1>
	<p><?php printf( __( 'Are you sure you want to delete this %s? This action is irreversible.', 'edd_fes' ), EDD_FES()->vendors->get_product_constant_name( $plural = false, $uppercase = false ) ); ?></p>
