...
<table class="table fes-table table-condensed  table-striped" id="fes-product-list">
	...
	<tbody>
		...
		<?php endforeach;
			...
			echo '<tr><td colspan="7" class = "fes-product-list-td" >'. sprintf( __('No %s found','edd_fes'), EDD_FES()->vendors->get_product_constant_name( $plural = true, $uppercase = false ) ).'</td></tr>';
		}
		?>
	</tbody>
</table>
