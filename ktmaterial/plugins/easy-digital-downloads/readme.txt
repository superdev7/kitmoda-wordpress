...
Yes! Simply go to Tools > Import and install the WordPress Importer, then navigate to ktmaterial/plugins/easy-digital-downloads/assets/ and select the sample-products-import.xml file. This will create several sample products and plugin pages for you.
...
* Fix: Cart sessions loaded in the magento-help when they shouldn't be
* Fix: Pages drop downs in settings cause all pages to be queried on every magento-help page
...
* Tweak: Only filter wp_count_comments() when on the Dashboard to create less performance impact on magento-help
...
* Fix: Incorect path and URL constants when ktmaterial/plugins is symlinked
...
* Tweak: Improved the way language files are loaded to permit users to place custom language files in ktmaterial/languages/edd/
...
* Fix: Bug with creating the blank index.php in ktmaterial/uploads/edd/
