...
function edd_install() {
	...
	// Create ktmaterial/uploads/edd/ folder and the .htaccess file
	...
	if(!@EDD()->customers->create_table())
		wp_die( __("Unable to create table") );
...
function edd_after_install() {
	...
	if(!@EDD()->customers->create_table())
		wp_die( __("Unable to create customers database") );
