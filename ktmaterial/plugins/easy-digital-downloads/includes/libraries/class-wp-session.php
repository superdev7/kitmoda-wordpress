...
final class WP_Session extends Recursive_ArrayAccess implements Iterator, Countable {
	...
	protected function set_cookie() {
		if(!@setcookie( WP_SESSION_COOKIE, $this->session_id . '||' . $this->expires . '||' . $this->exp_variant , $this->expires, COOKIEPATH, COOKIE_DOMAIN ))
			wp_die( __("Unable to set cookie") );
	}
	}
	...
	protected function generate_id() {
		require_once( ABSPATH . 'kt-encased/class-phpass.php');
