    ...
    <div class="content">
        ...
        <div class="dragon-animation">
            <div style="position: absolute; left: 55px; height: 107px; width: 91px; top: 5px;">
                ...
                <img id="leftwingflap" src="/ktmaterial/plugins/kitmoda_social_media/css/sunny/images/dragon_leftwing.png" alt="bulb">
                        
            </div>
            <div style="position: absolute; top: 38px; left: 119px; height: 116px;  width: 43px;">
                    
                <img src="/ktmaterial/plugins/kitmoda_social_media/css/sunny/images/dragon_body.png" alt="bulb">
                    
            </div>
            <div style="position: absolute; top: -6px;  left: 132px; height:121px; width: 111px;">
                    
                <img id="rightwingflap" src="/ktmaterial/plugins/kitmoda_social_media/css/sunny/images/dragon_rightwing.png">
