...
<div class="content">
    <h1>Great! Let’s add images of your untextured model.</h1>
    ...
    <div class="images_upl_container">
        ...
        <div class="ubox items_container">
            ...
            <?=KSM_Form::images_upload_placeholder(reset($publisher->steps['images']['uploader']), $publisher->images_data());?>
    ...
    <div style="text-align: center">Please sort images into the correct categories.</div>
