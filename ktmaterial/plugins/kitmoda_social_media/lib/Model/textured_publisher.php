...
class KSM_TexturedPublisherModel extends KSM_BaseModel {
    ...
    public function validate_description($return_data = false) {
        ...
        $data['textured_price'] = $_POST['textured_price'];
        $data['untextured_price'] = $_POST['untextured_price'];
        ...
        if($v->validate()) {
            ...
            elseif(count(explode(',', $data['keywords'])) > 10) {
