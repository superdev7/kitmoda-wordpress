...
var kmvg_gallery = Base.extend({
    ...
    onGridItemClick : function() {
        this.switchView('full', $(this).closest('.item_kit_mosaic').attr('indx'));
    },
    ...
    miniGridCountSize : function() {
        ...
        $(this.mini_grid_ele + ' .item_kit_mosaic').each(function() {
    ...
    clearGallery : function(k) {
        ...
        //this.mini_grid_ele+ ' .grid_kit_mosaic'
        
        
        var gme = $(this.mini_grid_ele+ ' .grid_kit_mosaic');
        var ge = $(this.mini_grid_ele+ ' .grid_kit_mosaic');
    ...
    initMiniGrid : function() {
        ...
        var imagesAnimationDuration = 1000;
          ...
          // init Isotope
var $grid = $('.grid_kit_mosaic').isotope({
  itemSelector: '.item_kit_mosaic',
...
$grid.imagesLoaded().progress( function() {
  $grid.isotope('layout');
    ...
    switchGallery : function(name) {
        ...
        _this.params.grid_ele = _this.params.gallery_ele+" .grid_view_container .grid_view_kit_mosaic .grid_kit_mosaic"
        _this.params.mini_grid_ele = _this.params.gallery_ele+" .mini_grid_view_container .grid_view_kit_mosaic .grid_kit_mosaic"
    ...
    initGalleryParams : function() {
        ...
        $.each(_this.params.galleries , function(k, v) {
            if($(_this.params.container+' .'+v+'_gallery .mini_grid_view_container .grid_kit_mosaic .item_kit_mosaic').length > 0) {
    ...
    init : function() {
        ...
        $(_this.params.container).delegate('.gallery .grid_view_kit_mosaic .item_kit_mosaic .bg, '+_this.params.container+' .gallery .grid_view_kit_mosaic .item_kit_mosaic img', 'click', _this.onGridItemClick);
            ...
            if(gallery.found) {
                ...
                if($(g_container).length > 0) {
                    $.each(gallery.mini.slides, function(si, s) {
                        $(g_container+' .mini_grid_view_container .grid_kit_mosaic').append(s);
                    });
                    ...
                    $(g_container+' .grid_view_container .grid_kit_mosaic').append(pele);
                    $.each(gallery.grid.slides, function(si, s) {
                        $(g_container+' .grid_view_container .grid_kit_mosaic #'+pele_id).append(s);
                    });
...
var kmvg = function (params) {
    ...
    _this.onGridItemClick = function() {
        _this.switchView('full', $(this).closest('.item_kit_mosaic').attr('indx'));
        $('html, body').animate({
    ...
    _this.miniGridCountSize = function() {
        ...
        $(_this.params.mini_grid_ele + ' .item_kit_mosaic').each(function() {
            var tt = parseInt($(this).css('top'));
            var th = parseInt($(this).css('height'));
            if(tt > t) {
                r++;
    ...
    _this.clearGallery = function(k) {
        ...
        var gme = $(g_container+ ' .mini_grid_view_container .grid_kit_mosaic');
        var ge = $(g_container+ ' .grid_view_container .grid_kit_mosaic');
...
$grid.imagesLoaded().progress( function() {
  $grid.isotope('layout');
    ...
    _this.switchGallery = function(name) {
        ...
        console.log($(_this.params.mini_grid_ele + ' .item_kit_mosaic').length);
        if($(_this.params.mini_grid_ele + ' .item_kit_mosaic').length == 0) {
