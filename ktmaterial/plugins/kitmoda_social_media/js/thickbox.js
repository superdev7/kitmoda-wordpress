...
var tb_pathToImage = "images/wpspin_light-2x.gif";
...
jQuery(document).ready(function(){
	...
	imgLoader.src = tb_pathToImage;
        ...
        jQuery('.ksm_reset_image').click(function(e){
            e.preventDefault();
            jQuery(this).closest('.form-field').find('#tag-image').val('');
            jQuery(this).closest('.form-field').find('img').hide();
        });
});
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			if(url.indexOf('TB_iframe') != -1){// either iframe or ajax window
					...
					if(params['modal'] != "true"){//iframe no modal
						jQuery("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>"+caption+"</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title=''><img src='images/no.png' /></a></div></div><iframe frameborder='0' hspace='0' src='"+urlNoQuery[0]+"' id='TB_iframeContent' name='TB_iframeContent"+Math.round(Math.random()*1000)+"' onload='tb_showIframe()' style='width:"+(ajaxContentW + 29)+"px;height:"+(ajaxContentH + 17)+"px;' ></iframe>");
					}else{//iframe modal
