...
class KSM_Validator
{
    ...
    /**
     * Validate that a field is price
     *
     * @param  string  $field
     * @param  mixed   $value
     * @return bool
     */
    protected function validatePrice($field, $value) {
        
        if(($this->validateInteger($field, $value) || $this->validateFloat($field, $value)) &&
            $value > 0) {
            return true;
        } 
