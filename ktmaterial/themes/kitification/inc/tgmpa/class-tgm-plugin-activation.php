    ...
    class TGM_Plugin_Activation {
        ...
        public function admin_init() {
            ...
            if ( isset( $_REQUEST['tab'] ) && 'plugin-information' == $_REQUEST['tab'] ) {
                require_once ABSPATH . 'magento-help/includes/plugin-install.php'; // Need for install_plugin_information().
        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' == $_GET['tgmpa-install'] ) ) {
                ...
                require_once ABSPATH . 'magento-help/includes/plugin-install.php'; // Need for plugins_api.
                require_once ABSPATH . 'magento-help/includes/class-wp-upgrader.php'; // Need for upgrade classes.
            ...
            elseif ( isset( $_GET['plugin'] ) && ( isset( $_GET['tgmpa-activate'] ) && 'activate-plugin' == $_GET['tgmpa-activate'] ) ) {
                ...
                if ( is_wp_error( $activate ) ) {
                    ...
                    if ( ! isset( $_POST['action'] ) ) {
                        ...
                        echo '<div id="message" class="updated"><p>' . htmlentities($msg,ENT_QUOTES) . '</p></div>';
                    }
                }
            }
        ...
        public function process_bulk_actions() {
            ...
            if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
                ...
                if ( is_wp_error( $activate ) ) {
                    ...
                    printf( '<div id="message" class="updated"><p>%1$s %2$s.</p></div>', _n( 'The following plugin was activated successfully:', 'The following plugins were activated successfully:', $count, 'tgmpa' ), htmlentities($imploded,ENT_QUOTES) );
                }
...
function tgmpa_load_bulk_installer() {
    ...
    if ( ! class_exists( 'WP_Upgrader' ) && ( isset( $_GET['page'] ) && TGM_Plugin_Activation::$instance->menu === $_GET['page'] ) ) {
        require_once ABSPATH . 'magento-help/includes/class-wp-upgrader.php';
