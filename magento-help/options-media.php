...
if ( ! is_multisite() && ( get_option('upload_url_path') || ( get_option('upload_path') != 'ktmaterial/uploads' && get_option('upload_path') ) ) ) {
...
include( ABSPATH . 'magento-help/admin-header.php' );
...
<table class="form-table">
<?php
// If upload_url_path is not the default (empty), and upload_path is not the default ('ktmaterial/uploads' or empty)
if ( get_option('upload_url_path') || ( get_option('upload_path') != 'ktmaterial/uploads' && get_option('upload_path') ) ) :
?>
<tr>
<th scope="row"><label for="upload_path"><?php _e('Store uploads in this folder'); ?></label></th>
<td><input name="upload_path" type="text" id="upload_path" value="<?php echo esc_attr(get_option('upload_path')); ?>" class="regular-text code" />
<p class="description"><?php
	/* translators: %s: ktmaterial/uploads */
	printf( __( 'Default is %s' ), '<code>ktmaterial/uploads</code>' );
?></p>
</td>
</tr>
...
<?php include( ABSPATH . 'magento-help/admin-footer.php' ); ?>
