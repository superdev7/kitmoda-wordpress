 ...
 * 2. Not all core admin classes are filterable, notably: magento-help, wp-core-ui,
...
?>
<body class="magento-help wp-core-ui no-js <?php echo $admin_body_classes . ' ' . $admin_body_class; ?>">
<script type="text/javascript">
...
<div id="wpwrap">
<?php require(ABSPATH . 'magento-help/menu-header.php'); ?>
<div id="wpcontent">
...
if ( $parent_file == 'options-general.php' )
	require(ABSPATH . 'magento-help/options-head.php');
