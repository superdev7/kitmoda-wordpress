...
if ( get_option('db_upgraded') ) {
	 ...
	 *
	 * In single site, the user would be redirected to magento-help/upgrade.php.
	 ...
	 */
		...
		if ( $c <= 50 || ( $c > 50 && mt_rand( 0, (int)( $c / 50 ) ) == 1 ) ) {
			...
			/** This action is documented in magento-help/network/upgrade.php */
...
require_once(ABSPATH . 'magento-help/includes/admin.php');
 ...
 * $wp_importers is sometimes set in magento-help/includes/import.php
...
if ( WP_NETWORK_ADMIN )
	require(ABSPATH . 'magento-help/network/menu.php');
elseif ( WP_USER_ADMIN )
	require(ABSPATH . 'magento-help/user/menu.php');
else
	require(ABSPATH . 'magento-help/menu.php');
...
if ( isset($plugin_page) ) {
	if ( $page_hook ) {
		...
		if (! isset($_GET['noheader']))
			require_once(ABSPATH . 'magento-help/admin-header.php');
