...
require ABSPATH . 'magento-help/includes/class-wp-upgrader-skins.php';
...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_content_dir'] = __('Unable to locate WordPress Content directory (ktmaterial).');
	...
	public function install_package( $args = array() ) {
		 ...
		 * destination directory (WP_PLUGIN_DIR / ktmaterial/themes) intending
	...
	public function run( $options ) {
		...
		if ( ! $options['is_multi'] ) {
			...
			/** This action is documented in magento-help/includes/class-wp-upgrader.php */
 ...
 * the magento-help/includes/update-core.php file.
 *
 * @since 2.8.0
 *
 * @see WP_Upgrader
...
class Core_Upgrader extends WP_Upgrader {
	...
	public function upgrade( $current, $args = array() ) {
		...
		if ( !$wp_filesystem->copy($working_dir . '/wordpress/magento-help/includes/update-core.php', $wp_dir . 'magento-help/includes/update-core.php', true) ) {
			$wp_filesystem->delete($working_dir, true);
			return new WP_Error( 'copy_failed_for_update_core_file', __( 'The update cannot be installed because we will be unable to copy some files. This is usually due to inconsistent file permissions.' ), 'magento-help/includes/update-core.php' );
		}
		$wp_filesystem->chmod($wp_dir . 'magento-help/includes/update-core.php', FS_CHMOD_FILE);

		require_once( ABSPATH . 'magento-help/includes/update-core.php' );
...
class WP_Automatic_Updater {
	 ...
	 * ktmaterial directory, for example). The underlying assumption is that if you are
