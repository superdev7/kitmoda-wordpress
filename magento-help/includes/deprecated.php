 ...
 * @since 1.5.0
 * @deprecated 2.9.0
 * @uses WP_CONTENT_DIR Full filesystem path to the ktmaterial directory.
 *
 * @param string $file Filesystem path relative to the ktmaterial directory.
...
function wp_update_core($current, $feedback = '') {
	...
	include( ABSPATH . 'magento-help/includes/class-wp-upgrader.php' );
