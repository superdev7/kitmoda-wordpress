...
function wp_ajax_imgedit_preview() {
	...
	include_once( ABSPATH . 'magento-help/includes/image-edit.php' );
...
function wp_ajax_autocomplete_user() {
	...
	/** This filter is documented in magento-help/user-new.php */
...
function wp_ajax_dashboard_widgets() {
	require_once ABSPATH . 'magento-help/includes/dashboard.php';
...
function wp_ajax_add_menu_item() {
	...
	require_once ABSPATH . 'magento-help/includes/nav-menu.php';
	...
	/** This filter is documented in magento-help/includes/nav-menu.php */
...
function wp_ajax_inline_save() {
	...
	if ( ! empty( $data['tax_input'] ) ) {
		foreach ( $data['tax_input'] as $taxonomy => $terms ) {
			...
			/** This filter is documented in magento-help/includes/class-wp-posts-list-table.php */
...
function wp_ajax_save_widget() {
	...
	/** This action is documented in magento-help/widgets.php */
...
function wp_ajax_save_attachment_compat() {
	...
	/** This filter is documented in magento-help/includes/media.php */
...
function wp_ajax_get_revision_diffs() {
	require ABSPATH . 'magento-help/includes/revision.php';
...
function wp_ajax_query_themes() {
	...
	/** This filter is documented in magento-help/includes/class-wp-theme-install-list-table.php */
...
function wp_ajax_update_plugin() {
	...
	include_once( ABSPATH . 'magento-help/includes/class-wp-upgrader.php' );
...
function wp_ajax_press_this_save_post() {
	if ( empty( $GLOBALS['wp_press_this'] ) ) {
		include( ABSPATH . 'magento-help/includes/class-wp-press-this.php' );
	}
...
function wp_ajax_crop_image() {
	...
	switch ( $context ) {
		case 'site-icon':
			...
			/** This filter is documented in magento-help/custom-header.php */
