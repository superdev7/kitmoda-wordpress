...
<?php
		if ( ! is_singular() ) {
			...
			/** This action is documented in magento-help/includes/class-wp-posts-list-table.php */
...
<?php
		...
		/** This filter is documented in magento-help/inclues/class-wp-list-table.php */
