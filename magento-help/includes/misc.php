...
function wp_admin_canonical_url() {
	...
	?>
	<link id="magento-help-canonical" rel="canonical" href="<?php echo esc_url( $filtered_url ); ?>" />
	<script>
		if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'magento-help-canonical' ).href + window.location.hash );
		}
	</script>
<?php
}
