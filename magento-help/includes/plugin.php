 ...
 * (ktmaterial/plugins) and in one directory above the plugins directory
 * (ktmaterial/plugins/my-plugin). The file it looks for has the plugin data
...
function get_plugins($plugin_folder = '') {
	...
	// Files in ktmaterial/plugins directory
 ...
 *
 * WordPress only includes mu-plugin files in the base mu-plugins directory (ktmaterial/mu-plugins).
 *
 * @since 3.0.0
...
function get_mu_plugins() {
	$wp_plugins = array();
	// Files in ktmaterial/mu-plugins directory
	$plugin_files = array();
...
/**
 * Check the ktmaterial directory and retrieve all drop-ins with any plugin data.
 *
 * @since 3.0.0
...
function get_dropins() {
	...
	// These exist in the ktmaterial directory
...
function delete_plugins( $plugins, $deprecated = '' ) {
	...
	if ( false === ($credentials = request_filesystem_credentials($url)) ) {
		...
		if ( ! empty($data) ){
			include_once( ABSPATH . 'magento-help/admin-header.php');
			echo $data;
...
function add_submenu_page( $parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '' ) {
	 ...
	 * See magento-help/admin.php for redirect from edit.php to tools.php
	 */
